...
namespace WebCrawler.Tests
{
    public class HtmlParserTests
    {
        ...
        private readonly HtmlParser _service = new HtmlParser();
        ...
        public void GetLinks_HtmlData_ShouldReturnLinksList(string html, params string[] expectedValue)
        {
            ...
            //act
            var result = _service.GetHtmlLinks(html).ToArray();
        ...
        public void GetLinks_Null_ShouldReturnNullReferenceException()
        {
            ...
            //act
            var res = Assert.Throws<NullReferenceException>(() => _service.GetHtmlLinks(html));
